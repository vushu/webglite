...
if((c === "\n")){
var G__20976 = escape_QMARK_;
var G__20977 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__20976;
lines = G__20977;
continue;
} else {
buf.append(c);

var G__20978 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__20979 = lines;
escape_QMARK_ = G__20978;
lines = G__20979;
continue;
