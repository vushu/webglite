...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__24680_SHARP_){
var _STAR_delimiter_STAR_24681 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__24680_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_24681;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4534__auto__ = [];
var len__4531__auto___24690 = arguments.length;
var i__4532__auto___24691 = (0);
while(true){
if((i__4532__auto___24691 < len__4531__auto___24690)){
args__4534__auto__.push((arguments[i__4532__auto___24691]));

var G__24692 = (i__4532__auto___24691 + (1));
i__4532__auto___24691 = G__24692;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__24686){
var vec__24687 = p__24686;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__24687,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq24682){
var G__24683 = cljs.core.first.call(null,seq24682);
var seq24682__$1 = cljs.core.next.call(null,seq24682);
var G__24684 = cljs.core.first.call(null,seq24682__$1);
var seq24682__$2 = cljs.core.next.call(null,seq24682__$1);
var G__24685 = cljs.core.first.call(null,seq24682__$2);
var seq24682__$3 = cljs.core.next.call(null,seq24682__$2);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24683,G__24684,G__24685,seq24682__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__24693 = rewrite_clj.reader.peek.call(null,reader);
switch (G__24693) {
case "(":
...
var G__24695 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__24695)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__24695)){
...
if(cljs.core._EQ_.call(null,"_",G__24695)){
