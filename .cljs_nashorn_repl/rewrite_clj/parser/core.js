...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__20989_SHARP_){
var _STAR_delimiter_STAR_20990 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__20989_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_20990;
}}));
});
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__20995){
var vec__20996 = p__20995;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__20996,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq20991){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20992,G__20993,G__20994,seq20991__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__21002 = rewrite_clj.reader.peek.call(null,reader);
switch (G__21002) {
case "(":
...
var G__21004 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__21004)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__21004)){
...
if(cljs.core._EQ_.call(null,"_",G__21004)){
